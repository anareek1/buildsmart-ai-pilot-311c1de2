      ...
      <div className="p-8 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-card rounded-xl border p-6">
            <h2 className="font-semibold mb-4">Выполнение по объектам (%)</h2>
            <ResponsiveContainer width="100%" height={260}>
              <BarChart data={objectProgress} barGap={4}>
          ...
          {/* Revenue Trend */}
          <div className="bg-card rounded-xl border p-6">
            <h2 className="font-semibold mb-4">Доходы и расходы (млн ₸)</h2>
            <ResponsiveContainer width="100%" height={260}>
              <LineChart data={monthlyTrend}>
                ...
                <YAxis tick={{ fontSize: 11 }} />
                <Tooltip />
                <Line type="monotone" dataKey="revenue" name="Доходы" stroke="hsl(22, 90%, 52%)" strokeWidth={2} dot={{ r: 4 }} />
                <Line type="monotone" dataKey="expenses" name="Расходы" stroke="hsl(var(--muted-foreground))" strokeWidth={2} dot={{ r: 4 }} />
              </LineChart>
            </ResponsiveContainer>
          </div>
        </div>
        ...
        {/* Weekly summary */}
        <div className="bg-card rounded-xl border p-6">
          <h2 className="font-semibold mb-4">Еженедельная сводка — 7-13 апреля 2026</h2>
